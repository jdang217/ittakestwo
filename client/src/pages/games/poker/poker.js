...
import './poker.css';
import { burnAndTurn, createDeck, dealCards, flop, performflop, shuffleDeck } from './gameLogic'; 
    ...
    const deal = async () => {
        ...
        for (var i = 0; i < numPlayers; i++) {
            ...
            if (channel === "HOST") {
                ...
                clientChannels.forEach((channel) => {
                    console.log(channel.label, dealtCards[i].player)
        ...
        console.log(shuffledDeckRef.current)
    }
